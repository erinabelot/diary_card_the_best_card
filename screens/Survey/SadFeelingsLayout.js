...
export default function SadFeelingsLayout( { pageAnswer, setPageAnswer, handleSaveAndNext, question, readResponse  } ) {
   
  readResponse(question)

  const sliderColor = '#BDE1F5';
  return (
    <>
     <ScrollView contentContainerStyle={styles.container}>
     
        <Text style={styles.headingText}>Sad</Text>
